WP Real Estate WordPress Theme
GNU GPL v3
...
Demo Here: http://demo.rohitink.com/wpre/
...
2. Search for "WP Real Estate".
3. Click on Install and Activate.

Alternatively,

1. Go to WP Admin > Appearance > Themes > Add New > Upload.
2. Upload the wpre.zip file, in which you found this README.txt
3. Click on Install and Activate.
...
WP Real Estate is a relatively new theme, and could contain some hidden bugs. So, if you find any please report them at the following URL:

 https://rohitink.com/2016/01/05/wpre-multipurpose-theme/
...
7. Themeisle Plugin Recommender
	- GPL Licnese
	- https://wordpress.org/themes/hesta	
...
The images were obtained from the Pixabay.com
